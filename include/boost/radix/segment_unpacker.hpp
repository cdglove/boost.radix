...
//        // [2, 2, 2, 2]
//        bits_type bits = packed[0];
//        unpacked[0]    = (bits >> 0) & mask<2>::value;
//        unpacked[1]    = (bits >> 2) & mask<2>::value;
//        unpacked[2]    = (bits >> 4) & mask<2>::value;
//        unpacked[3]    = (bits >> 6) & mask<2>::value;
//    };
//};
//
//template <>
...
//    {
//        // [2, 3, 3], [1, 3, 3, 1], [3, 3, 2]
//        unpacked[0] = (packed[0] >> 0) & mask<3>::value;
//        unpacked[1] = (packed[0] >> 3) & mask<3>::value;
//        unpacked[2] = ((packed[0] >> 6) & mask<2>::value) |
//                      ((packed[1] >> 0) & mask<1>::value);
//        unpacked[3] = (packed[1] >> 1) & mask<3>::value;
//        unpacked[4] = (packed[1] >> 4) & mask<3>::value;
//        unpacked[5] = ((packed[1] >> 7) & mask<1>::value) |
//                      ((packed[2] >> 0) & mask<2>::value);
//        unpacked[6] = (packed[3] >> 2) & mask<3>::value;
//        unpacked[7] = (packed[3] >> 5) & mask<3>::value;
//    }
//};
//
//template <>
...
//        // [4, 4]
//        bits_type bits = packed[0];
//        unpacked[0]    = (bits >> 0) & mask<4>::value;
//        unpacked[1]    = (bits >> 4) & mask<4>::value;
//    }
//};
//
//template <>
...
//    static void unpack(PackedSegment const& packed, UnpackedSegment& unpacked)
//    {
//        // [3, 5], [1, 5, 2], [4, 4], [2, 5, 1], [5, 3]
//        unpacked[0] = (packed[0] >> 0) & mask<5>::value;
//        unpacked[1] = ((packed[0] >> 5) & mask<3>::value) |
//                      ((packed[1] >> 0) & mask<2>::value);
//        unpacked[2] = (packed[1] >> 2) & mask<5>::value;
//        unpacked[3] = ((packed[1] >> 7) & mask<1>::value) |
//                      ((packed[2] >> 0) & mask<4>::value);
//        unpacked[4] = ((packed[2] >> 4) & mask<4>::value) |
//                      ((packed[3] >> 0) & mask<1>::value);
//        unpacked[5] = (packed[3] >> 1) & mask<5>::value;
//        unpacked[6] = ((packed[3] >> 6) & mask<2>::value) |
//                      ((packed[4] >> 0) & mask<3>::value);
//        unpacked[7] = (packed[4] >> 3) & mask<5>::value;
//    }
//};
//
//template <>
